...
function GoogleProvider(arg0: { clientId: string | undefined; clientSecret: string | undefined; authorization: { params: { prompt: string; access_type: string; response_type: string } } }): import("next-auth/providers/index").Provider {
